...
const UpdateProductInputSchemaNormal = {
...
const UpdateProductInputSchema = z.object(UpdateProductInputSchemaNormal);
...
export { updateProduct, UpdateProductInputSchemaNormal }; 